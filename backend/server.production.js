...
app.post("/api/admin/logout",auth,async(req,res,next)=>{try{req.admin.sessionVersion=Number(req.admin.sessionVersion||0)+1;await req.admin.save();clearCookie(res);res.json({ok:true});}catch(e){next(e);}});
